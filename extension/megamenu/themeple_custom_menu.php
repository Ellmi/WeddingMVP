...
if( !class_exists( 'tzeverline_themeple_custom_menu' ) )
...
{	
	...
	class tzeverline_themeple_custom_menu

	{
		...
		function tzeverline_themeple_custom_menu()
...

		{
			...
			return 'tzeverline_themeple_custom_menu_backend';
...

		{
			...
			{	
				...
				wp_enqueue_style(  'themeple_custom_menu', THEME_PATH . '/extension/assets/css/themeple_custom_menu.css');

				wp_enqueue_script( 'themeple_custom_menu' , THEME_PATH . '/extension/assets/js/themeple_custom_menu.js',array('jquery', 'jquery-ui-sortable'), false, true );
		...
		function change_menu_arguments($arguments){
			...
			$arguments['walker'] = new tzeverline_custom_walker();
...
if( !class_exists( 'tzeverline_custom_walker' ) )

{



	class tzeverline_custom_walker extends Walker {
...
if( !class_exists( 'tzeverline_themeple_custom_menu_backend' ) )
 ...
 */
	...
	class tzeverline_themeple_custom_menu_backend extends Walker_Nav_Menu
			...
			<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo $itemValue; echo implode(' ', $classes ); ?>">
				...
				<dl class="menu-item-bar">
					...
					<dt class="menu-item-handle">
						...
						<span class="item-controls">
							...
							<a class="item-edit" id="edit-<?php echo $item_id; ?>" title="<?php _e('Edit Menu Item', 'themeple'); ?>" href="<?php
				...
				<div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
					...
					<div class='themeple_custom_menu_options'>
						...
						<p class="description description-wide themeple_checkbox themeple_custom_mega_menu themeple_custom_mega_menu_d0">
							...
							<label for="edit-<?php echo $key.'-'.$item_id; ?>">
								...
								<input type="checkbox" value="active" id="edit-<?php echo $key.'-'.$item_id; ?>" class=" <?php echo $key; ?>" name="<?php echo $key . "[". $item_id ."]";?>" <?php echo $value; ?> /><?php _e( $title, 'themeple' ); ?>
					...
					<div class="menu-item-actions description-wide submitbox">
						...
						); ?>"><?php _e('Remove', 'themeple'); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo $item_id; ?>" href="<?php	echo add_query_arg( array('edit-menu-item' => $item_id, 'cancel' => time()), remove_query_arg( $removed_args, admin_url( 'nav-menus.php' ) ) );

							?>#menu-item-settings-<?php echo $item_id; ?>"><?php _e('Cancel', 'themeple'); ?></a>
